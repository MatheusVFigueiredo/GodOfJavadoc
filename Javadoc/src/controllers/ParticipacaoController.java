...
public class ParticipacaoController {
	...
	public void associaProfessor(String cpf, int codigo, boolean coordenador, double valorHora, int qtdHoras) throws Exception{
		try{
			...
			throw new Exception(Util.ERRO_ASSOCIACAO + e.getMessage());
		}
	}
	...
	public void associaGraduando(String cpf, int codigo, double valorHora, int qtdHoras) throws Exception{
		try{
			verificaCodigoCpf(cpf, codigo);
